                ...
                ->arrayNode('view')->addDefaultsIfNotSet()
					->children()
						...
						->arrayNode('mail')->addDefaultsIfNotSet()
							->children()
								->scalarNode('notify')->cannotBeEmpty()->defaultValue('BrotherQuestBundle:Mail:notify.txt.twig')->end()
							->end()
						->end()	
                ...
                ->arrayNode('form')->addDefaultsIfNotSet()
                    ->children()
                        ->arrayNode('entry')->addDefaultsIfNotSet()
                            ->children()
                                ->scalarNode('name')->cannotBeEmpty()->defaultValue('brother_quest_entry')->end()
                                ->scalarNode('type')->cannotBeEmpty()->defaultValue('brother_quest_entry')->end()
                                ->scalarNode('class')->cannotBeEmpty()->defaultValue('Brother\QuestBundle\Form\Type\EntryType')->end()
                            ->end()
                        ->end()
                    ->end()
                ->end()
